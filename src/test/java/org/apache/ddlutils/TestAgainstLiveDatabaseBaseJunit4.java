 ...
 * @see TestAgainstLiveDatabaseBase
 */
public abstract class TestAgainstLiveDatabaseBaseJunit4 extends TestPlatformBase {
  ...
  protected static final Log log = LogFactory.getLog(TestAgainstLiveDatabaseBaseJunit4.class);
  /**
  ...
  protected static Properties readTestProperties(String propFile) {
    ...
    try {
      propStream = TestAgainstLiveDatabaseBaseJunit4.class.getResourceAsStream(propFile);
      if (propStream == null) {
  ...
  protected CreationParameters getTableCreationParameters(Database model) {
    ...
    for (Map.Entry<Object, Object> objectObjectEntry : _testProps.entrySet()) {
