...
/**
 * A utility class for executing SQL scripts from a Reader against a database connection.
 * This class can handle scripts line-by-line or as a full script, supports custom delimiters,
 * and provides options for error handling and transaction management.
 *
 * <p>Usage example:
 * <pre>{@code
 ...
 * runner.runScript(new FileReader("path/to/sql/script.sql"));
 * }</pre>
 *
 * <p>Another example with custom delimiter:
 * <pre>{@code
 * ScriptRunner runner = new ScriptRunner(connection);
 * runner.setDelimiter("//"); // Set custom delimiter
 * runner.setFullLineDelimiter(true); // Use full line as delimiter
 * runner.runScript(new StringReader(sqlScript));
 * }</pre>
 *
 * <p>The class supports:
 * <ul>
 *   <li>Custom statement delimiters via {@code @DELIMITER} comments in the script</li>
 *   <li>Comment handling (both {@code --} and {@code //} style)</li>
 *   <li>Warning handling options</li>
 *   <li>Error logging and custom error handling</li>
 *   <li>Full script vs line-by-line execution modes</li>
 *   <li>CR removal option for cross-platform compatibility</li>
 *   <li>Escape processing control</li>
 * </ul>
 */
