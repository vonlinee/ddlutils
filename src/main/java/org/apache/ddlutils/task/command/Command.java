...
public abstract class Command {
   ...
   */
  protected void handleException(Exception ex, String msg) throws CommandExecuteException {
    if (isFailOnError()) {
      if (ex instanceof CommandExecuteException) {
        throw (CommandExecuteException) ex;
      } else {
        throw new CommandExecuteException(msg, ex);
      }
    } else {
      _log.error(msg, ex);
    }
